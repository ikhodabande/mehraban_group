...
const Home = () => {
  return (
    ...
    <div className='w-full h-screen  absolute top-0 -z-1 flex justify-center'>
      ...
      <div className='w-[100%] sm:w-[95%] h-[80%] sm:h-[60%] shadow-xl absolute bg-[#ef6f14c2] top-[50%] sm:top-[70%] rounded-xl sm:grid sm:grid-cols-6 gap-5 flex flex-col-reverse items-center justify-center sm:scale-100 scale-90 z-10 sm:z-50'>
      <div className='bg-[#ef6f1400] w-full h-full p-4 flex items-center overflow-x-auto overflow-y-hidden rounded-xl col-span-5 scale-90 sm:scale-100 z-50'>
